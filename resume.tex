...
\item[Infrastructures:] Git, MySQL, MongoDB, Node.js, Linux OS (Ubuntu, Fedora)
% \item[Miscellaneous:]
...
\item
    ...
    \begin{itemize}
        ...
        \item Uses Global Positioning System (GPS) to determine vicinity of device, Radio Frequency Identification (RFID) to identity exact location, and Android/Swift to create a mobile app to easily manage tracking
        \item Technologies used: Android, Swift, RFID, GPS
    \end{itemize}
% \item
...
\item
    ...
    \end{itemize}
\item
    \ressubheading{Inline}{Durham, NC}{HackDuke}{November 2-3, 2019}
    \begin{itemize}
    ...
    \end{itemize}
\item
    \ressubheading{Stockastic}{Atlanta, GA}{HackGT}{October 25-27, 2019}
    \begin{itemize}
