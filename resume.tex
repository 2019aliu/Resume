...
\item
    ...
    \begin{itemize}
        ...
        \resitem{Developed 1st Accessibility Service for VR Product Foundation (VRPF) organization in Kotlin, contributing the first Kotlin code to VRPF}
        ...
        % \resitem{Reference names: Christopher Dinh, Ram N, }
...
\item
    ...
    \begin{itemize}
        ...
        % \resitem{References: Adarsh Rai, Nicholas Wolter}
