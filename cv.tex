...
\begin{itemize}\item[]
    \ressubheading{Georgia Institute of Technology}{GPA: 3.7 \hspace{1em} Atlanta, GA}{M.S. Computer Science -- Interactive Intelligence}{August 2022 - May 2023}
        \begin{itemize}
            ...
            \end{itemize}
            \resitem{Coursework: Natural Language Processing, Design and Analysis of Algorithms, Artificial Intelligence, Data and Visual Analytics, Machine Learning, Deep Learning, Human Computer Interaction}
        \end{itemize}
...
\item
    ...
    \begin{itemize}
        ...
        \resitem{Automatically generated topics of Fed meeting agendas with NLP text analysis and generative statistical models}  % Latent Dirichlet Allocation
...
\item
	...
	\begin{itemize}
		\resitem{Administrator of a new website for cultural and enrichment center, managing a system of tens of thousands of users.}
...
\begin{description}
% may need to get rid of slashes when submitting for ATS machine resume screeener
\item[Languages:] Python, JavaScript/TypeScript, Kotlin/Java, SQL, Golang
...
\item[Infrastructures, Frameworks, and Software:] React.js, Android, MySQL, PyTorch, Tensorflow, Node.js, Git/Mercurial, Spring Framework, Figma, MongoDB, Firebase, Keras, SCSS/SASS
...
\begin{itemize}
\resitem{Executive Board Member, Pianoforte at Georgia Tech}
\resitem{Social Committee Member, Georgia Tech Swim Club}
\resitem{Google Developer Student Club at Georgia Tech}
\resitem{Georgia Tech Investment Club}
\end{itemize}
% \begin{itemize}
% \item
...
% \resheading{High School Community Leadership}
% \begin{itemize}
% \item
