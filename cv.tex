...
\item
    ...
    \begin{itemize}
        ...
        \resitem{Talk to client to understand the product's specifications}
    \end{itemize}
\item
    ...
    \end{itemize}
\item
    \ressubheading{Mentor - Gieia}{New York City, NY - remote}{Freelance work}{July 2020 - Present}
    \begin{itemize}
    ...
    \end{itemize}
\item
    \ressubheading{Recycling Management Suite}{Atlanta, GA - remote}{Google Developer Student Club, Georgia Tech Chapter}{June 2020 - Present}
    \begin{itemize}
...
\item
    ...
    \end{itemize}
% \item
%     \ressubheading{Member, Georgia Tech Product Managers}{Atlanta, GA}{Georgia Tech}{April 2020 - Present}
%     \begin{itemize}
%         \resitem{Learn how to manage product development, particularly for computer software}
%     \end{itemize}
\item
